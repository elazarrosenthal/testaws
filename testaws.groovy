...
// create new instace and get id
   ...
   writeFile file: 'input.json', text: 'bdev'

   aws2 = aws(senv, [ " ec2 run-instances   --image-id ami-3d787d57 --count 1 --instance-type t2.micro --key-name ", "elazartest1",  " --security-group-ids sg-27f9af42 --subnet-id subnet-96d526e1 ", "file://input.json"])
   ii = extractiid(aws2)
